...
export const mockOrders = [
  ...
  {
    instrument: { id: 47, type: 'ACCION', name: 'Pampa Holding S.A.', ticker: 'PAMP' },
    size: 50,
    price: 930,
    side: OrderSide.BUY,
  ...
  {
    instrument: { id: 31, type: 'ACCION', name: 'Banco Macro S.A.', ticker: 'BMA' },
    size: 20,
    price: 1540,
    side: OrderSide.BUY,
  ...
  {
    instrument: { id: 54, type: 'ACCION', name: 'MetroGAS S.A.', ticker: 'METR' },
    size: 500,
    price: 250,
    side: OrderSide.BUY,
